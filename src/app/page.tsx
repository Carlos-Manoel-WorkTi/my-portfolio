...
export default function Home() {
  ...
  return (
    ...
    <main className="flex  flex-col items-center  overflow-x- main">
      ...
      <div className="w-full text-white h-20 pt-5 pl-6 py-4 animate__animated animate__slideInLeft animate__delay-1s">
        <h4 className="flex items-center inf-full">
          I am 
          <strong className="flex items-center text-green-600 ml-2 inf-name italic ">
            ...
            Carlos
          </strong>, a web developer,
        </h4>
        <h4 className="inf-full">
        Check out my portfolio to explore my latest <Link href={"/projects"} className="border-b border-green-500 ">projects</Link>.
    ...
    <form action="#" className="w-full h-auto mt-10 mb-9 flex justify-center flex-col pl-5">

      <label>*Entre em contato:</label>
      <div className="w-full h-auto mt-10 mb-9 flex justify-start">

      <input
        className="ipt text-zinc-600 font-mono ring-1 ring-zinc-400 focus:ring-2 focus:ring- outline-none duration-300 placeholder:text-zinc-600  rounded-full px-4 py-2 shadow-md focus:shadow-lg dark:shadow-md "
        autoComplete="off"
        placeholder="Digite algo..."
        name="text"
        type="text"
      />
      <span className=" sp bg-zinc-200 text-zinc-600 font-mono ring-1 ring-zinc-400 focus:ring-2 focus:ring-rose-400 outline-none duration-300 placeholder:text-zinc-600 placeholder:opacity-50 rounded-full px-2 py-2 rotate-[45deg] ml-2 shadow-md focus:shadow-lg focus:shadow-rose-400 dark:shadow-md ">
        <svg
      ...
      <div className="w-full h-80">Em andamento...</div>
    </form>
    </>
  );
}
