...
export const fallbackProjects: ProjectItem[] = [
  ...
  },
  {
    ...
    "description": "DayFlow é um app para registrar o dia a dia do usuário, marcando horários, tarefas, atividades e oferecendo insights automáticos com IA para produtividade e autoanálise.",
    "color": "#3b82f6",
    "date": "2024",
    ...
    "context": "Criado para auxiliar usuários a acompanhar sua rotina, o DayFlow combina registro diário de atividades, controle de agenda e insights gerados por IA, ajudando na reflexão e planejamento pessoal.",
    "preview": "",
    "technologies": [
      "React",
      "Firebase",
  ...
  },
  {
    ...
    "description": "DuoWord é uma plataforma interativa para aprender inglês de forma divertida e imersiva, combinando música, histórias e desafios linguísticos personalizados com recursos de gamificação e progresso em tempo real.",
    ...
    "preview": "",
    "context": "DuoWord foi criado para transformar o aprendizado de idiomas em uma experiência interativa e personalizada. O usuário aprende inglês ouvindo músicas, explorando histórias narradas e salvando palavras que encontra durante a jornada.",
    "content": [
      {
        "title": "Contexto",
  ...
  },
  {
    ...
    "description": "Planets Cards é um jogo de memória interativo e educativo que desafia os jogadores a combinar pares de cartas sobre os planetas do Sistema Solar, estimulando o raciocínio, a concentração e o aprendizado de forma divertida.",
    "color": "#d33030",
    "date": "2024",
    "technologies": [
      "JavaScript (ES6+)",
    ...
    "preview": "",
    "context": "Planets Cards foi desenvolvido para unir aprendizado e diversão, combinando a simplicidade de um jogo da memória com o fascínio do universo e seus planetas.",
    "content": [
      {
        "title": "Contexto",
  ...
  },
  {
    ...
    "description": "Talk Learning é um aplicativo web inteligente que utiliza IA para ensinar inglês por meio de conversas interativas e personalizadas. A proposta é transformar o aprendizado em uma experiência natural, envolvente e adaptada ao ritmo de cada usuário.",
    "color": "#48d330",
    "date": "2023",
    "technologies": [
      "React",
    ...
    "preview": "",
    "context": "Talk Learning foi criado com o objetivo de modernizar o aprendizado de inglês através de uma experiência de conversação guiada por IA. O sistema simula diálogos reais e oferece feedback dinâmico, tornando o processo de aprendizado mais natural e intuitivo.",
    "content": [
      {
        "title": "Contexto",
  ...
  },
  {
    ...
    "description": "O projeto 'TEC Notícias' é um portal de notícias voltado ao universo da tecnologia, desenvolvido para entregar informações atualizadas de forma acessível, responsiva e inclusiva.",
    ...
    "preview": "",
    "context": "TEC Notícias foi criado com o objetivo de democratizar o acesso à informação tecnológica, trazendo notícias confiáveis e adaptadas a diferentes públicos. O projeto também busca aplicar práticas de acessibilidade e design inclusivo.",
    "content": [
      {
        "title": "Contexto e Objetivo",
  ...
  },
  {
    ...
    "description": "Conversor de Moedas é uma aplicação back-end desenvolvida em Java que realiza conversões monetárias em tempo real, integrando-se à API Exchangerate para buscar as taxas de câmbio mais recentes com precisão e eficiência.",
    "color": "#1abc9c",
    "date": "2024",
    "technologies": [
      "Java 17",
    ...
    "preview": "",
    "context": "O Conversor de Moedas foi criado para oferecer uma solução prática e precisa para conversões financeiras, consumindo dados atualizados de APIs externas e apresentando os resultados de forma ágil e confiável.",
    "content": [
      {
        "title": "Contexto",
  ...
  },
  {
    ...
    "description": "Java Poster é uma aplicação back-end em Java com Spring Boot para criação de posts, gerenciamento de comentários e autenticação segura via JWT.",
    "color": "#f39c12",
    "date": "2024",
    "technologies": [
      "Java",
    ...
    "preview": "",
    "context": "Java Poster foi desenvolvido para demonstrar um back-end seguro e escalável, com autenticação JWT, controle de acesso por perfis e versionamento de banco via Flyway.",
    "content": [
      {
        "title": "Contexto",
  ...
  },
  {
    ...
    "description": "BooksJava é uma API back-end em Java desenvolvida com Spring Boot para gerenciamento e consulta de informações de livros.",
    "color": "#8e44ad",
    "date": "2024",
    "technologies": [
      "Java",
    ...
    "preview": "",
    "context": "BooksJava foi desenvolvido como uma API RESTful que realiza o gerenciamento completo de livros, oferecendo endpoints para cadastro, atualização, listagem e exclusão.",
    "content": [
      {
        "title": "Contexto",
  ...
  },
  {
    ...
    "description": "TVZ é um aplicativo completo de streaming com canais ao vivo, conteúdos sob demanda e recursos interativos — desenvolvido em versões Web e Mobile.",
    "color": "#e74c3c",
    "date": "2024",
    "technologies": [
      "Next.js",
    ...
    "preview": "",
    "context": "O TVZ é um sistema de streaming dividido em três módulos — Web, Mobile e API back-end — oferecendo suporte a canais de TV ao vivo, vídeos sob demanda e autenticação JWT. A versão Web está online, enquanto a versão Mobile (APK) contém recursos mais completos, otimizados para reprodução de mídia nativa.",
    "content": [
      {
        "title": "Contexto",
  ...
  },
  {
    ...
    "description": "Primeon é uma landing page de ecommerce premium construída com React, Vite e Shadcn/UI, destacando produtos de alto padrão com navegação fluida, parallax e animações suaves.",
    "color": "#8B5CF6",
    "date": "2025",
    "technologies": [
      "Vite",
    ...
    "preview": "",
    "context": "Primeon foi criado para oferecer uma experiência de ecommerce sofisticada, combinando design moderno, navegação intuitiva e efeitos visuais elegantes que destacam produtos premium.",
    "content": [
      {
        "title": "Contexto",
  ...
  },
  {
    ...
    "description": "GameUp é uma plataforma de mini-games multiplayer em tempo real, com lobby interativo, partidas rápidas e suporte a diversos jogos. Atualmente, apenas um jogo foi implementado, mas a arquitetura permite expansão fácil para outros jogos.",
    "color": "#e76225",
    "date": "2025",
    "technologies": [
      "Vite",
    ...
    "preview": "",
    "context": "GameUp foi desenvolvido como uma plataforma de mini-games multiplayer fullstack, combinando frontend Vite + React com back-end Node.js + Express + Socket.IO. A ideia é permitir que novos jogos sejam adicionados facilmente no futuro, criando uma coleção de jogos interativos e em tempo real.",
    "content": [
      {
        "title": "Contexto",
  ...
  },
  {
    ...
    "description": "TVZ Guide é uma API back-end que automatiza a captura de horários de programas de TV do dia via web scraping, disponibilizando dados estruturados para consumo externo.",
    "color": "#1d72b8",
    "date": "2024",
    "technologies": [
      "Node.js",
    ...
    "preview": "",
    "context": "TVZ Guide foi desenvolvido como uma ferramenta back-end para coletar automaticamente a programação televisiva diária de diversos canais e disponibilizá-la em formato de API RESTful, permitindo integração com outras aplicações.",
    "content": [
      {
        "title": "Contexto",
  ...
  },
  {
    ...
    "description": "Encontre seu GitHub é uma aplicação frontend em React para adicionar e visualizar repositórios do GitHub de forma prática e intuitiva.",
    "color": "#24292e",
    "date": "2022",
    "technologies": [
      "React",
  ...
  },
  {
    ...
    "description": "Lumo é um assistente virtual com IA generativa, oferecendo conversas naturais, produtivas e personalizadas diretamente no navegador.",
    "color": "#236bd8",
    "date": "2025",
    "technologies": [
      "Next.js",
  ...
  },
  {
    ...
    "description": "Nag é um chatbot inteligente para WhatsApp, atuando como atendente virtual e assistente multifuncional.",
    "color": "#25D366",
    "date": "2025",
    "technologies": [
      "Baileys",
  ...
  },
  {
    ...
    "description": "FireBurg é um site moderno para divulgação de um restaurante, focado em performance e experiência do usuário.",
    "color": "#E63946",
    "date": "2025",
    "technologies": [
      "Vite",
  ...
  },
  {
    ...
    "description": "Nova Reveal é uma landing page interativa com foco em animações suaves e experiência do usuário.",
    "color": "#7C3AED",
    "date": "2025",
    "technologies": [
      "Vite",
...
export function getFallbackProjectByName(name: string): ProjectItem | null {
  return fallbackProjects.find((project) => project.title === name) ?? null;
}
